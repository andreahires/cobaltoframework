package com.cobalto.extended.magnolia.view.components
{
	...
	*/
	...
	public class MagnoliaRightSideOnlyBar extends Sprite
	{
		...
		public function MagnoliaRightSideOnlyBar(width:Number,menuXML:XMLList,preview:Boolean=false)
		{
			super();
			_width = width;
		...
		public function build():void
		{
			...
			if(_leftButtons)
			{
				...
				_leftMenu.mouseEnabled=false;
				_leftMenu.mouseChildren=false;
				_leftMenu.visible=false;
				addChild(_leftMenu);
			}

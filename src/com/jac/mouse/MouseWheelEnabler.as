package com.jac.mouse
{
	...
	public class MouseWheelEnabler
	{
		...
		static private var callId:String;
		
		public static function init(stage:DisplayObject, useRawDelta:Boolean = false ):void
		{
			if( !initialised )
			{
				//trace("-------------> init Mouse Wheel");
				initialised = true;
		...
		private static function registerListenerForMouseMove( stage : DisplayObject ) : void
		{
		...
		{
			//trace("MOuse Whell remove listener");
			ExternalInterface.call('mws.removeScrollListeners');
		}
		
		public static function addListener():void
		{
			//trace("MOuse Whell add listener");
			ExternalInterface.call('mws.addScrollListeners');
		}
	}
}
